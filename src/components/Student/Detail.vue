            ...
            <div class="p-6 space-y-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-800">{{ formatDate(record.date) }}</p>
                    </div>
                    <div>
                        <span :class="[
                            ...
                            {{ record.status === 'completed' ? 'เสร็จสมบูรณ์' : 'รอเช็คเอาท์' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-green-50 rounded-lg p-4">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-sm font-medium text-gray-700">เวลาเข้า</span>
                        </div>
                    ...
                    <div class="bg-orange-50 rounded-lg p-4">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-sm font-medium text-gray-700">เวลาออก</span>
                        </div>
